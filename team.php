                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <a href="team.php" class="nav-item nav-link active">The Team</a>
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <div class="column mx-n2">
                    <div class="col-4 px-1 mb-2">
                        <a href=""><img class="w-100" src="img/sell1.jpg" alt=""></a>
                    </div>
                    <div class="col-4 px-1 mb-2">
                        <a href=""><img class="w-100" src="img/sell3.jfif" alt=""></a>
                    </div>
                    <div class="col-4 px-1 mb-2">
                        <a href=""><img class="w-100" src="img/sell4.jfif" alt=""></a>
                    </div>
                    <div class="col-4 px-1 mb-2">
                        <a href=""><img class="w-100" src="img/sell6.jfif" alt=""></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 mb-5"> 
