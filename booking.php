<?php
    ...
    if(!$_SESSION['loggedin']){
        echo "<script>alert('Please log in first.');location.replace('./login.php')</script>";
    }
...
<body>
    ...
    <div class="col-lg-10 text-center">
        <h2>Here at Bike Rental motorbike, booking procedure is really simple.</h2> <p>With certain criteria, you will be touring on your favourite bike. All you need to do is fill up a form and handover following documents:</p> 
        <div class="col-lg-10 text-left">
       <h5> 1. Identity (ID) Card.<h5> 2. Passport for foreigners. <h5>3. License. </h5> </p></div>
<p>We encourage advanced payment system. Security Deposit is necessary at the beginning and will be refunded after the trip or booked time.

<p>For any damage; in the look and external appearance of the bike, the client is responsible.</p> </div>
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="mb-5">
                        <div class="row">
                            ...
                            <div class="col-6 form-group">
                                <input type="text" class="form-control p-4" placeholder="Full Name" name="fname" required="required">
                
                            </div>
                            <div class="col-6 form-group">
                                <input type="text" class="form-control p-4" placeholder="Mobile Number" name="number" required="required">
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 form-group">
                            <input type="date" class="form-control p-4" placeholder="Arriving Date" name="adate" required="required">
                            </div>
                        </div>    
                        
                            <div class="row">
                            <div class="col-6 form-group">
                                <input type="text" class="form-control p-4" value="<?php echo $i['pTitle'] ?>" name="fbike" readonly>
                
                            </div>
                            <div class="col-6 form-group">
                                <input type="text" class="form-control p-4" value="<?php echo $i['pPrice'] ?>" name="price" readonly>
                            </div>
</div>
                        <div class="form-group">
                            <textarea class="form-control py-3 px-4" rows="3" placeholder="Hiring Detail" name="hiring" required="required"></textarea>
                        </div>
    </div> 
                </div>
                <div class="col-lg-4">
                    <div class="bg-secondary p-5 mb-5">
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input" name="payment" id="esewa" value="esewa">
                                <label class="custom-control-label" for="esewa">Esewa</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input" name="payment" id="khalti" value="khalti">
                                <label class="custom-control-label" for="khalti">Khalti</label>
                            </div>
                        </div>
                        <div class="form-group mb-4">
                            <div class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input" name="payment" id="fonepay" value="fonepay">
                                <label class="custom-control-label" for="fonepay">Fone Pay</label>
                            </div>
                        </div>
