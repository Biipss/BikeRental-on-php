...
<body>
                    ...
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <a href="bike.php" class="nav-item nav-link">Bikes</a>
                            <!-- <div class="dropdown-menu rounded-0 m-0">
                                <a href="bike.php" class="dropdown-item active">Bike Listing</a>
    ...
    <div class="container-fluid page-header">
        <h1 class="display-3 text-uppercase text-white mb-3">Bike Listing</h1>
        <div class="d-inline-flex text-white">
            <h6 class="text-uppercase m-0"><a class="text-white" href="">Home</a></h6>
            <h6 class="text-body m-0 px-3">/</h6>
            <h6 class="text-uppercase text-body m-0">Bike Listing</h6>
        </div>
    </div>
    <!-- Page Header Start -->

    <?php include 'bikelist.php' ?>
    <!-- Rent A Car End -->
